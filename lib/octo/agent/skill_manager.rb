...
module Octo
  class Agent
    ...
    module SkillManager
      ...
      #
      # For encrypted skills, both messages are marked transient: true so they
      ...
      # Scan ~/.octo/memories/ and return a formatted summary of all memory files.
      ...
      def load_memories_meta
        ...
        lines = ["Available memory files in ~/.octo/memories/:"]
        lines << ""
