...
RSpec.describe Octo::AnthropicStreamAggregator do
  ...
  it "passes parse_response through to canonical usage shape" do
    ...
    parsed = Octo::MessageFormat::Anthropic.parse_response(agg.to_h)
  ...
  it "assembles thinking blocks into the response" do
    ...
    parsed = Octo::MessageFormat::Anthropic.parse_response(result)
